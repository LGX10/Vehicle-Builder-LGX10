...
class Cli {
  ...
  createCar(): void {
    inquirer
      ...
      .then((answers) => {
        const car = new Car(
          Cli.generateVin(), // The generateVin method is static and should be called using the class name Cli
          answers.color,
          answers.make,
          answers.model,
    ...
    inquirer
      ...
      .then((answers) => {
        const truck = new Truck(
          ...
          parseInt(answers.weight),
          parseInt(answers.topSpeed),
          [], // Assuming wheels are added later or default empty array
          ...
          switch (answers.action) {
            ...
            case 'Tow a vehicle':
              if (selectedVehicle instanceof Truck) {
                ...
                return; // to avoid calling performActions again immediately
              } else {
